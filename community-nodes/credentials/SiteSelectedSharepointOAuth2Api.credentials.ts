 ...
 */
export class SiteSelectedSharepointOAuth2Api implements ICredentialType {
  name = 'siteSelectedSharepointOAuth2Api';
  icon: Icon = { light: 'file:../icons/sharepoint.svg', dark: 'file:../icons/sharepoint.dark.svg' };
  displayName = 'Site Selected SharePoint OAuth2 API';
  documentationUrl =
    'https://bcgov.github.io/common-hosted-workflow/community-nodes/site-selected-sharepoint/credentials';
  extends = ['oAuth2Api'];
