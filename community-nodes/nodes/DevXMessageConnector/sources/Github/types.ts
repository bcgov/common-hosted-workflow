...
// See https://github.com/octokit/webhooks/tree/main/payload-examples/ghes-35
// See https://github.com/octokit/webhooks/blob/main/payload-types/schema.d.ts
export type Schema =
...
export type BranchProtectionRuleEnforcementLevel = 'off' | 'non_admins' | 'everyone';
...
export type CheckSuiteEvent = CheckSuiteCompletedEvent | CheckSuiteRequestedEvent | CheckSuiteRerequestedEvent;
...
export type AuthorAssociation =
  ...
  | 'NONE'
  | 'OWNER';
export type CustomPropertyEvent = CustomPropertyCreatedEvent | CustomPropertyDeletedEvent;
...
export type InstallationRepositoriesEvent = InstallationRepositoriesAddedEvent | InstallationRepositoriesRemovedEvent;
export type InstallationTargetEvent = InstallationTargetRenamedEvent;
export type IssueCommentEvent = IssueCommentCreatedEvent | IssueCommentDeletedEvent | IssueCommentEditedEvent;
export type IssuesEvent =
  ...
  | IssuesUnlockedEvent
  | IssuesUnpinnedEvent;
export type LabelEvent = LabelCreatedEvent | LabelDeletedEvent | LabelEditedEvent;
...
export type MemberEvent = MemberAddedEvent | MemberEditedEvent | MemberRemovedEvent;
export type MembershipEvent = MembershipAddedEvent | MembershipRemovedEvent;
export type MergeGroupEvent = MergeGroupChecksRequestedEvent | MergeGroupDestroyedEvent;
...
export type RegistryPackageEvent = RegistryPackagePublishedEvent | RegistryPackageUpdatedEvent;
...
export type WorkflowStep = WorkflowStepInProgress | WorkflowStepQueued | WorkflowStepCompleted;
export type WorkflowRunEvent = WorkflowRunCompletedEvent | WorkflowRunInProgressEvent | WorkflowRunRequestedEvent;
...
export interface DeploymentStatusCreatedEvent {
  ...
  deployment_status: {
     ...
     */
    state: 'pending' | 'in_progress' | 'success' | 'failure' | 'error' | 'waiting' | 'queued';
    creator: User;
    /**
