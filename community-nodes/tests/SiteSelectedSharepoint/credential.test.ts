...
import { SiteSelectedSharepointOAuth2Api } from '../../credentials/SiteSelectedSharepointOAuth2Api.credentials';

describe('SiteSelectedSharepointOAuth2Api credential', () => {
  const credential = new SiteSelectedSharepointOAuth2Api();

  it('has the expected name and extends oAuth2Api', () => {
    expect(credential.name).toBe('siteSelectedSharepointOAuth2Api');
