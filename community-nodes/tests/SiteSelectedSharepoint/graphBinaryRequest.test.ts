...
import { graphBinaryRequest } from '../../nodes/SiteSelectedSharepoint/transport/graphRequest';
...
describe('graphBinaryRequest', () => {
  it('returns the body/headers on the first successful call', async () => {
    ...
    expect(requestOAuth2.mock.calls[0][0]).toBe('siteSelectedSharepointOAuth2Api');
