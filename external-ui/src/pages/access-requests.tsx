  ...
  return (
    <div className="mx-auto max-w-7xl px-6 py-10 lg:py-12">
      <section className="max-w-6xl space-y-6">
        ...
        ) : listQuery.isLoading || whoamiQuery.isLoading ? (
          ...
          <DialogContent>
            ...
            <div className="space-y-4">
              <div className="space-y-2">
                ...
                <p className="text-sm">{reviewingRequest?.requesterEmail}</p>
              </div>
              <div className="space-y-2">
                <Label className="text-sm font-medium">Justification</Label>
                <p className="text-sm text-[var(--bc-muted)]">{reviewingRequest?.justification}</p>
              </div>
              <div className="space-y-2">
              ...
              <DialogFooter>
                ...
                >
                  ...
                  {reviewMutation.isPending ? 'Denying...' : 'Deny Request'}
                </Button>
              </DialogFooter>
            </div>
          </DialogContent>
